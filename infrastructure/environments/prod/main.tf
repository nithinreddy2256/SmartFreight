...
locals {
  ...
  microservices = {
    shipment-orchestrator = { port = 8080, cpu = 1024, memory = 2048, desired = 3 }
    carrier-integration   = { port = 8081, cpu = 1024, memory = 2048, desired = 3 }
    invoice-processing    = { port = 8082, cpu = 2048, memory = 4096, desired = 2 }
    notification          = { port = 8083, cpu = 512, memory = 1024, desired = 2 }
    document-management   = { port = 8084, cpu = 1024, memory = 2048, desired = 2 }
    analytics             = { port = 8085, cpu = 2048, memory = 4096, desired = 2 }
  }
}
