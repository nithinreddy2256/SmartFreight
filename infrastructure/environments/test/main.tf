...
module "kms" {
  ...
  alias_name              = "main"
  description             = "SmartFreight test environment master KMS key"
...
# ============================================================
# Aurora Clusters (Serverless v2 for test)
# ============================================================
...
module "cognito" {
  ...
  logout_urls                = ["https://test.smartfreight.internal/logout"]
  resource_server_identifier = "https://api.smartfreight.test"
